...
var fetchGetOnePosts = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", API/* default */.Z.get("/users/".concat(id, "/posts")).then(function (response) {
  ...
  return function fetchGetOnePosts(_x) {
...
var UserPostsPage = function UserPostsPage() {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Helmet/* Helmet */.q, {
      title: "User ".concat(id, " | Posts"),
      meta: [{
        'name': 'description',
        'content': 'All posts one user'
      }],
      link: [{
        'rel': 'icon',
...
/* harmony default export */ const User_UserPostsPage = (UserPostsPage);
